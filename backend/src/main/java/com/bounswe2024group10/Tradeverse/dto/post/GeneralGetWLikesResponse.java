...
public class GeneralGetWLikesResponse {
    ...
    public GeneralGetWLikesResponse(boolean isSuccessful, String message, List<Post> comments, List<Long> nofLikes, List<Long> nofDislikes) {
